...
/**
 * @file arduino_nano_wrapper.cpp
 *
 * Wrapper code for Arduino Nano Board
 *
...
#include <Arduino.h>
#include "arduino_nano_wrapper.h"
...
#include "libraries/arduino/SPI_AVR/SPI.cpp"
#include "libraries/arduino/Wire_AVR/Wire.cpp"
#include "libraries/arduino/Wire_AVR/twi.c"
...
{   // Servo 1 = Pin 29
    // Serov 8 = Pin 22
    _servo[num].attach(29-num);
    return;
}

extern "C" void _servo_write_us(uint8_T num,uint32_T val)
{
    _servo[num].writeMicroseconds(val);
    return;
}
